...
void init_offsets() {
    ...
    Offsets shared by:
    - @qwertyoruiop
     omggg its luk! wen eta appel whatche 17.37153 jelbrek!!?!1!! (jk, love you Luca! :D)
    - @Mila432
    - @Andywiik
    - @nicogibbons
    - @jtv7
    ...
    */
    ...
    if (strcmp(u.version, "Darwin Kernel Version 16.3.0: Tue Nov 29 21:40:09 PST 2016; root:xnu-3789.32.1~4/RELEASE_ARM64_T7001") == 0) {
        ...
        allproc_offset = 0x5b4168; /* 
                                    my family be like: Is this your homework? 0x5b4168 is uhhhh 0! That's easy as fuck
                                    
                                    me: No.
                                    
                                    family: * rage intensifies * 0 times whatever blah blah blah
                                    
                                    
                                    also, my family don't get full stops because they never stop talking...
                                    */
